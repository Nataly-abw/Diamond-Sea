			...
			success : function(response){
				...
				$.each(resp.message, function(index, value){
					brandHTML += '<tr class="tabData">'+
									...
									'<td><a class="btn btn-sm btn-info edit-category tabBttns"><span style="display:none;">'+JSON.stringify(value)+'</span>Edit</a>&nbsp;<a cid="'+value.cat_id+'" class="btn btn-sm btn-danger delete-category tabBttns">Delete</i></a></td>'+
								'</tr>';
				});
